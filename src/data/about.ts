  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        "The same deliberation shaped the visual identity. The mark is the Arabic letter Noon (ن) — the first letter of al-Nizam — read as celestial mechanics: a tilted orbital band with a single point resting on it. The orbit is al-Nizam, the order that holds everything in relation; the point is the operator, held on that orbit and free to move because the structure does the holding. It carries the meaning of the framework in one silhouette, without a word of explanation.",
