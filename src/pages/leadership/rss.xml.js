    ...
    items: [
      {
        ...
        description: 'Why al-Nizam can be trusted with PII, HIPAA, PCI, and the work that makes the difference between safe and exposed. Part of the introducing-al-nizam series.',
        link: '/leadership/trust-comes-from-structure/',
      },
      {
        title: 'AI forgets everything the moment I close the tab',
        pubDate: new Date('2026-06-10'),
        description: 'How al-Nizam keeps continuity that does not depend on the AI tool remembering. Part of the introducing-al-nizam series.',
